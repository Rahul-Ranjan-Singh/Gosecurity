...
import 'package:gosec/constants.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          // (
          //     imageStr:
          //         "https://www.unwomen.org/-/media/headquarters/images/sections/news/stories/2017/11/fiji_varanisesemaisamoa_rakirakimarket_1_675pxwide.jpg?la=en&vs=13170", key: Key('yhg')),
          // Padding(
          //   padding: const EdgeInsets.symmetric(horizontal: 16.0),
          ...
          ArticleImage(
              imageStr:
                  "https://www.unwomen.org/-/media/headquarters/images/sections/news/stories/2018/8/tanzania_daressalaam_bettyjaphet-mtewelle_mchikinimarketvendor_august2018_002_1_960x640.jpg?la=en&vs=4847", key: Key('yghg')),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
