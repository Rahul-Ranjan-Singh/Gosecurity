...
class DashAppbar extends StatefulWidget {
  ...
  DashAppbar({required Key key, required this.getRandomInt, required this.quoteIndex}) : super(key: key);
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => SettingsScreen(key: Key("njnddjb"),)));
          },
          child: Padding(
