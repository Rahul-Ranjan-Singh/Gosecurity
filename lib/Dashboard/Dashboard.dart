...
import 'package:gosec/Dashboard/Home.dart';
import 'package:gosec/Dashboard/ContactScreens/MyContacts.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  List<Widget> screens = [Home(), MyContactsScreen(key: Key('jinjn'),)];
  bool alerted = false;
  int currentPage = 0;
  ...
  sendAlertSMS(bool isAlert) async {
    ...
    try {
      ...
      if (numbers.isEmpty) {
        ...
        String li = "http://maps.google.com/?q=";
        if (isAlert) {
          link = "Help Me! SOS \n$li";
        } else {
