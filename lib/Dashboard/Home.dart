...
import 'package:gosec/Dashboard/DashWidgets/Scream.dart';
import 'package:gosec/Dashboard/Dashboard.dart';
import 'package:gosec/Dashboard/Settings/SettingsScreen.dart';
import 'package:gosec/Fake%20call/fake.dart';
import 'package:gosec/SelfDefence/ho.dart';
import 'package:gosec/SwipeButton.dart';
import 'package:gosec/Dashboard/Articles%20-%20SafeCarousel/AllArticles.dart';
import 'package:gosec/Dashboard/DashWidgets/BookCab.dart';
import 'package:gosec/Dashboard/DashWidgets/DashAppbar.dart';
import 'package:gosec/Dashboard/DashWidgets/Emergency.dart';
import 'package:gosec/Dashboard/DashWidgets/LiveSafe.dart';
import 'package:gosec/Dashboard/Articles%20-%20SafeCarousel/SafeCarousel.dart';
import 'package:gosec/Dashboard/DashWidgets/OtherFeature.dart';
import 'package:gosec/Dashboard/DashWidgets/SafeHome.dart';
  ...
  _handleCommand(Map<String, dynamic> response) {
    switch (response["command"]) {
      ...
      case "police":
        ...
        break;
      case "spycam":
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => LiveFeed(key: Key("hgvbhjb"),)));
        break;
      case "home":
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => Dashboard(key: Key("hgbhjb"),)));
        break;
      case "contact":
      ...
      case "defence":
        ...
        break;
      case "setting":
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => SettingsScreen(key: Key("hgvbh"),)));
        break;
      case "pstation":
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => openMap("Police Stations near me")));
        break;
      case "article":
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => AllArticles(key: Key("hg"))));
        break;
      case "cab":
    ...
    return Column(
      ...
      children: [
        DashAppbar(
          ...
          quoteIndex: quoteIndex, key: Key("hgknknvbhjb"),),

        Expanded(
          child: ListView(
            shrinkWrap: true,
            children: [
              SafeCarousel(key: Key("hgvbhjmkjnb")),
              TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => AllArticles(key: Key("hgnknvbhjmkjnb")),
                    ),
                  );
                },
                child: Align(
              ...
              Emergency(key: Key("hgvvhvhvbhjmkjnb")),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 8.0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              OtherFeature(key: Key("hgvbnmnmhjmkjnb"),),
              // SizedBox(
              //   height: MediaQuery.of(context).size.height/6,
              //   child: Row(
              //     mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              BookCab(key: Key("hgvjnjbnhjmkjnb"),),
              ...
              LiveSafe(key: Key("hgvbjnjbjhjmkjnb")),
              Padding(
                padding: const EdgeInsets.only(left: 16.0, bottom: 10, top: 10),
                child: Text(
                  "Be Nirbhaya With",
              ...
              Scream(key: Key("hgnbjvbhjmkjnb")),
              SafeHome(key: Key("hgvnvhvhbhjmkjnb")),
              SwipeButtonDemo(key: Key("hgvbhjmkjnknknb"),pageRoute: "/fifth",
