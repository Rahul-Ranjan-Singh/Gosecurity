...
import 'package:gosec/Dashboard/Settings/AboutCard.dart';
      ...
      body: ListView(
        children: [
          AboutCard(
            ...
            title: "GoSecure",
            sizeFactor: 1.8, key: Key("hbdhjebn"),
          ),
          AboutCard(
            
            desc: "Aishwarya Srivastava - ITM ( GIDA, GORAKHPUR )",
            asset: "about",
            subtitle: "Made with ❤️ for Her!",
            title: "GoSecure Team",
            sizeFactor: 2.5, key: Key("bdnjnn"),
          ),
          Padding(
